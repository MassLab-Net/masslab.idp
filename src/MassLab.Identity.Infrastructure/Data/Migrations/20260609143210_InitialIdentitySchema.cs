        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MfaEnabledByPolicy = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefreshTokensEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    AccessTokenLifetimeMinutes = table.Column<int>(type: "integer", nullable: true),
                    RefreshTokenLifetimeDays = table.Column<int>(type: "integer", nullable: true),
                    AllowedFlows = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Enabled = table.Column<bool>(type: "boolean", nullable: false),
                    SubjectClaim = table.Column<string>(type: "text", nullable: false),
                    EmailClaim = table.Column<string>(type: "text", nullable: false),
                    DisplayNameClaim = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExternalLoginProviders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromDisplayName = table.Column<string>(type: "text", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPostLogout = table.Column<bool>(type: "boolean", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserExternalLoginLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserExternalLoginLinks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserExternalLoginLinks_ExternalLoginProviders_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "ExternalLoginProviders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsentRequired = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantDefaultPolicies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TenantDefaultPolicies_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientApplications_TenantId_ClientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantDefaultPolicies_TenantId",
                table: "TenantDefaultPolicies",
                column: "TenantId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantPermissions_TenantId_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserExternalLoginLinks_ProviderId",
                table: "UserExternalLoginLinks",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_UserExternalLoginLinks_UserId",
                table: "UserExternalLoginLinks",
                column: "UserId");
