...
import faviconUrl from "../assets/MassLab_Favicon.png";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Enterprise Identity & Access Management. Manage users, roles, permissions and organizations across a multi-tenant platform." },
      { property: "og:title", content: "MassLab IAM" },
      { property: "og:description", content: "Identity & Access Management for modern teams." },
