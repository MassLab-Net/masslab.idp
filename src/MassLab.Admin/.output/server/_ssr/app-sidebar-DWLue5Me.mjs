...
import { I as require_jsx_runtime, d as DialogContent, f as DialogDescription, h as DialogTitle, j as Slot, l as Dialog, m as DialogPortal, p as DialogOverlay, u as DialogClose } from "../_libs/@radix-ui/react-alert-dialog+[...].mjs";
...
import { C as LayoutDashboard, Q as UserRound, T as KeyRound, W as Building2, et as PanelLeft, f as ShieldCheck, n as X, r as Users, u as ShoppingCart, y as Package } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/app-sidebar-DWLue5Me.js
...
function AppSidebar() {
	...
	const tenant = [{
		title: t("nav.orgs"),
		url: "/admin/tenant/organizations",
		icon: Building2
	}];
	const catalog = [{
		title: t("nav.orders"),
	...
	const Section = ({ label, items }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [!collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupLabel, { children: label }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: items.map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuButton, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			...
			children: [
				...
				!collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: it.title }),
				!collapsed && isActive(it.url) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ml-auto h-1.5 w-1.5 rounded-full bg-gradient-brand" })
			]
		})
	}) }, it.url)) }) })] });
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sidebar, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, {
				className: "h-16 shrink-0 border-b border-sidebar-border px-3 !flex !flex-row items-center",
				children: collapsed ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logo, {
					size: 28,
					showWord: false
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logo, { size: 32 })
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarFooter, {
				...
				children: !collapsed && user && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-3 rounded-lg bg-sidebar-accent/60 p-2.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
//#endregion
export { initials as a, SidebarTrigger as i, SidebarInset as n, SidebarProvider as r, AppSidebar as t };
